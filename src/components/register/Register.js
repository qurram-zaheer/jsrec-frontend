...
export class Register extends React.Component{
    ...
    onSubmitRegister = () => {
        ...
        fetch('https://cryptic-falls-11765.herokuapp.com/register',{
            method: 'post',
        ...
        return(
            ...
            <main className="pa4 black-80">
                ...
                <div className="measure ">
                    ...
                    <div className="">
                    <input onClick =  {this.onSubmitRegister} className="br3 b ph3 pv2 input-reset ba b--black bg-transparent grow pointer f6 dib" type="submit" value="Sign up" />
                    </div>
